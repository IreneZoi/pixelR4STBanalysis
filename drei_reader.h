...
TH2I * hdxvsev = new  TH2I( "dxvsev", "Bx-Ax vs events;events;#Deltax [px];clusters", 100, 0, 10000, 100, -f, f );
...
TH2I * hclmapB3 = new TH2I( "clmapB3", "linked cluster map B;col;row;B clusters on tracks", 80, 0, 80, 320, 0, 320 );
