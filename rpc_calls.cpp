...
const unsigned int CTestboard::rpc_cmdListSize = 74;
...
const char *CTestboard::rpc_cmdName[] =
{
	...
	/*    53 */ "Daq_Read$C5SI",
	/*    54 */ "Daq_Read$C5SI0I",
	/*    55 */ "Ethernet_Send$v3c",
	/*    56 */ "Ethernet_RecvPackets$I",
	/*    57 */ "r4s_SetHoldPos$vC",
	/*    58 */ "r4s_AdcDelay$vC",
	/*    59 */ "r4s_SetSequence$v1I",
	/*    60 */ "r4s_SetRegX$v1I",
	/*    61 */ "r4s_SetRegY$v1I",
	/*    62 */ "r4s_Enable$vC",
	/*    63 */ "r4s_Start$v",
...
void CTestboard::r4s_SetVana(uint16_t rpc_par1)
{ RPC_PROFILING
	try {
