...
bool print=true;
using namespace std;
#define runNONirr0 "2793"
#define runNONirrB "2801"
#define runNONirrS "2815"
...
void controlPlotsPIrr_forThesis(TString name = "preliminary_beamdiv")
{

  TString inputDir="/home/zoiirene/Output/";
  TString outputDir="/home/zoiirene/Output/Plots/";
  TString base="#phi_{eq} = 2.1 #times 10^{15} cm^{-2}, proton, 800 V, 5.6 GeV";
  ...
  int i_dphcut[1] = {15};
  Double_t d_dphcut[1] = {15};
  TString ss_dphcut[1] = {"15"};
  TString inputfileNONirr= "beamdiv_A12C15";
  ...
  int color[angles] = {420,417,403}; // at zero color was 920
  ...
  float bin90[angles];
  TString ss_dphcuts[angles] = {"15","15","15"};
  TString runs[angles] = {runNONirr0,runNONirrB,runNONirrS};
  ...
  ofstream mylandau0;
  mylandau0.open ("/home/zoiirene/Output/TextFiles/FigX_ClusterCharge_PIrr_0deg.txt");
  ...
  //// Write Txt files for Robert
  ofstream mylandau1;
  mylandau1.open ("/home/zoiirene/Output/TextFiles/FigX_ClusterCharge_PIrr_8p8deg.txt");
  ...
  //// Write Txt files for Robert                                                                                                                                                                                                             
  ofstream mylandau2;
  mylandau2.open ("/home/zoiirene/Output/TextFiles/FigX_ClusterCharge_PIrr_27p5deg.txt");
  ...
  */
  ...
  TString  outname = outputDir+"Landau_PIrr_3Angles_"+name;
  ...
  for( int i = 0 ; i < angles; i ++){
    ...
    ofstream myres;
    myres.open ("/home/zoiirene/Output/TextFiles/FigY_ResidualWithTails_PIrr_"+angshort[i]+"deg.txt");
  ...
  TLegend* legB = new TLegend(0.1,0.83,0.4,0.88);
  legB->SetLineColor(0);
  //legFDB2->SetLegendFont(43);
  ...
  outname = outputDir+"ResPHAll_PIrr_3Angles_"+name;
  ...
  for( int i = 0 ; i < angles; i ++){
    ...
    cresph->Update();
    ofstream myres;
    myres.open ("/home/zoiirene/Output/TextFiles/FigW_ResidualWithoutTails_PIrr_"+angshort[i]+"deg.txt");
    myres << "Bin Center [um]  Content \n";
    for(int k=0; k < h_resq[i].GetNbinsX()+1; k++){
...
//legB->Draw();
  ...
  outname = outputDir+"ResPHAllnoLog_PIrr_3Angles_"+name;
  ...
  */
  ...
  ########### FIXMEEEEEEEEEEE : these numbers are not correct!!!
  ...
  */
  ...
  //Write Txt Files for Robert
  ofstream mycl0;
  mycl0.open ("/home/zoiirene/Output/TextFiles/FigW_ClusterSize_PIrr_"+angshort[0]+"deg.txt");
  ...
  mycl0.close();
  ofstream mycl1;
  mycl1.open ("/home/zoiirene/Output/TextFiles/FigW_ClusterSize_PIrr_"+angshort[1]+"deg.txt");
  ...
  mycl1.close();
  ofstream mycl2;
  mycl2.open ("/home/zoiirene/Output/TextFiles/FigW_ClusterSize_PIrr_"+angshort[2]+"deg.txt");
  ...
  TLegend*legB2 = new TLegend(0.12,0.88,0.7,0.92);
  ...
  */
  ...
  legnB90->Draw();
  outname = outputDir+"ClB90PHAll_PIrr_3Angles_"+name;
  ...
  outname = outputDir+"PxPH_PIrr_BestAngle_"+name;
