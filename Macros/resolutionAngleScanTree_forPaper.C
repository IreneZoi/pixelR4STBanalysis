...
void resolutionAngleScanTree_forPaper(TString thr="500",TString name = "preliminary_TreeCorr", TString func = "RMSself", bool unfolding = false)
{
  ...
  resolutionPlotN[0]->GetYaxis()->SetRangeUser(0.,8.);
