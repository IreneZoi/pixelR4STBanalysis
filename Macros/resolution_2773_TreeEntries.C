...
void resolution_2773_TreeEntries(TString function = "RMS95")
{
  ...
  TString labelB[Angles]={"Pspray_default_FDB, thr 26 ADC"};
  ...
  int i_dphcut[dphcuts] = {26};
  TString ss_dphcut[dphcuts] = {"26"};
  ...
  for(int i=0; i<Angles; i++){
      ...
      myfile[i].open ("/home/zoiirene/Output/TextFiles/Ascan_rmsTree_"+detectorB[i]+"_dphcutB"+ss_dphcut[i]+"_"+function+"_testEntries.txt");
