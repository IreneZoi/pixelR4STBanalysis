...
void resolutionVSmomentum2832_2840_studentT(TString func = "RMS")
{
  ...
  TString labelB="FDB150Y_2_R4S100x25-Y6_1, 120 V, thr 12 ADC";
  ...
  resolutionPlotInvSquare->GetYaxis()->SetTitle("Resolution^{2} [#mum^{2}]");
 ...
 resolutionPlotInvSquare->GetXaxis()->SetLabelSize(0.07);
 resolutionPlotInvSquare->GetXaxis()->SetTitleSize(0.07);
 resolutionPlotInvSquare->GetXaxis()->SetTitleOffset(0.9);
 resolutionPlotInvSquare->GetXaxis()->SetTitleFont(42);

 resolutionPlotInvSquare->GetYaxis()->SetLabelFont(42);
 resolutionPlotInvSquare->GetYaxis()->SetLabelSize(0.07);
 resolutionPlotInvSquare->GetYaxis()->SetTitleSize(0.07);
 resolutionPlotInvSquare->GetYaxis()->SetTitleOffset(0.7);
 ...
 resolutionPlotInvSquare->GetYaxis()->SetNoExponent(3);
  ...
  TLegend* leg42 = new TLegend(0.45,0.25,0.8,0.45);
  leg42->SetLineColor(0);
  leg42->SetTextSize(0.03);
  ...
  leg42->AddEntry(resolutionPlotInvSquare,"non irr, 120V, optimal angle" ,"ep");
  leg42->AddEntry(fit32,"#sigma_{hit}^{2}+(#sigma_{MS}/momentum)^{2}" , "l");
  leg42->Draw();
  c42->Update();
