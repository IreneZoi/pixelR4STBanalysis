...
void resolutionAngleScan_IEEE(TString thr="500",TString name = "preliminary", TString func = "RMS", bool unfolding = false)
{
  ...
  irr[1] = "#phi_{eq} = 2.1 #times 10^{15} cm^{-2}, proton";
  ...
  //resolutionPlot[0]->GetXaxis()->SetLabelSize(0.045);
  //resolutionPlot[0]->GetXaxis()->SetTitleSize(0.045);
  //resolutionPlot[0]->GetYaxis()->SetLabelSize(0.045);
  //resolutionPlot[0]->GetYaxis()->SetTitleSize(0.045);
  ...
  //  clsizePlot[0]->GetXaxis()->SetLabelSize(0.045);
  //clsizePlot[0]->GetXaxis()->SetTitleSize(0.045);
  //clsizePlot[0]->GetYaxis()->SetLabelSize(0.045);
  //clsizePlot[0]->GetYaxis()->SetTitleSize(0.045);
  ...
  TLegend* leg3 = new TLegend(0.2,0.7,0.5,0.85);
  leg3->SetLineColor(0);
  ...
  pad1->cd(); 
  //  TDR2(c3);
  TString  outname = outputDir+"ResolutionSummary_angleScans25_freshVSprot_withclsize_line2_newlabel_600"+name;
