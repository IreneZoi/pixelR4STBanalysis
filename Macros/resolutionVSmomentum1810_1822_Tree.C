...
void resolutionVSmomentum1810_1822_Tree(TString func = "RMSself")
{
  ...
  TString labelB="FDB150P_12_R4S100x25-P1_4, 600 V, thr 20 ADC";
  ...
  int i_dphcut[dphcuts] = {20};
  TString ss_dphcut[dphcuts] = {"20"};
  ...
  ofstream myfile;
  myfile.open ("/home/zoiirene/Output/TextFiles/Mscan_"+detectorB+"_"+func+"_rmsTree_"+label+".txt");
  myfile << "A " << detectorA << "\n";
  myfile << labelA << "\n";
  myfile << "B " << detectorB<< "\n";
  myfile << labelB << "\n";
  ...
  name = outputDir+"RMS_vs_InvEnergySquared_"+func+"_A_"+detectorA+"_B_"+detectorB+"_C_"+detectorC;  
  c4->SaveAs(name+".eps");
  c4->SaveAs(name+".pdf");
  c4->SaveAs(name+".png");
  */
  ...
  ofstream myfile2;
  myfile2.open ("/home/zoiirene/Output/TextFiles/Mscan_"+detectorB+"_"+func+"_resTree_"+label+".txt");
  myfile2 << "A " << detectorA << "\n";
  myfile2 << labelA << "\n";
  myfile2 << "B " << detectorB<< "\n";
  myfile2 << labelB << "\n";
  ...
  myfile2 << labelC << "\n";
  myfile2 << info << "\n";
  myfile2 << "Momentum(GeV) RMS(um) Error\n";
  ...
  //  TDR();
  TCanvas *c42 = new TCanvas("c42", "resolution vs inverse beam energy squared", 1000, 700);
  c42->SetLeftMargin(0.12);
  c42->SetRightMargin(0.03);
 ...
 resolutionPlotInvSquare->GetXaxis()->SetLabelSize(0.05);
 resolutionPlotInvSquare->GetXaxis()->SetTitleSize(0.055);
 ...
 resolutionPlotInvSquare->GetYaxis()->SetLabelSize(0.05);
 resolutionPlotInvSquare->GetYaxis()->SetTitleSize(0.055);
 resolutionPlotInvSquare->GetYaxis()->SetTitleOffset(1.);
 resolutionPlotInvSquare->GetYaxis()->SetTitleFont(42);
 resolutionPlotInvSquare->GetYaxis()->SetNoExponent(3);
  


  resolutionPlotInvSquare->GetYaxis()->SetRangeUser(0.,300.);
  resolutionPlotInvSquare->GetXaxis()->SetLimits(0.,0.6);

  //  TF1 *fit1 = new TF1("fit1","pol1", 0.15, 1.255); 
  //  TF1 *fit32 = new TF1("fit32","pol1", 0., 0.3 ); //0.45); 
  ...
  for(int i=0; i<2;i++)
    {
      ...
      strfit_err2[i] << fixed << setprecision(2) << 0.5*fit32->GetParError(i)/sqrt(fit32->GetParameter(i));
  ...
  TLegend* leg42 = new TLegend(0.45,0.25,0.85,0.5);
  leg42->SetLineColor(0);
  leg42->SetTextSize(0.038);
  ...
  leg42->AddEntry(resolutionPlotInvSquare,"#phi_{eq} = 2.1 #times10^{15} cm^{-2}, proton" ,"ep");
  leg42->AddEntry(resolutionPlotInvSquare,"600V, optimal angle" ,"");
  ...
  resolutionPlotMyParam->GetYaxis()->SetRangeUser(0.,20.);
  ...
  TLegend* leg42f = new TLegend(0.4,0.65,0.85,0.85);
 ...
 resolutionPlotMyParam->GetXaxis()->SetLabelFont(42);
 resolutionPlotMyParam->GetXaxis()->SetLabelSize(0.05);
 resolutionPlotMyParam->GetXaxis()->SetTitleSize(0.05);
 resolutionPlotMyParam->GetXaxis()->SetTitleOffset(0.9);
 resolutionPlotMyParam->GetXaxis()->SetTitleFont(42);

 resolutionPlotMyParam->GetYaxis()->SetLabelFont(42);
 resolutionPlotMyParam->GetYaxis()->SetLabelSize(0.05);
 resolutionPlotMyParam->GetYaxis()->SetTitleSize(0.05);
 resolutionPlotMyParam->GetYaxis()->SetTitleOffset(0.7);
 resolutionPlotMyParam->GetYaxis()->SetTitleFont(42);
 resolutionPlotMyParam->GetYaxis()->SetNoExponent(3);
  ...
  resolutionPlotMyParam->Draw("AEP");
  fnotsq->Draw("same");
  TLegend* leg42b = new TLegend(0.5,0.6,0.9,0.85);
  leg42b->SetLineColor(0);
  leg42b->SetTextSize(0.038);
  leg42b->SetBorderSize(0);
  // leg42->AddEntry(resolutionPlotInvSquare,"c"+detectorB+" "+labelB , "ep");
  // leg42->AddEntry(resolutionPlotInvSquare,"A: c"+detectorA+" "+labelA ,"");
  // leg42->AddEntry(resolutionPlotInvSquare,"C: c"+detectorC+" "+labelC ,"");
  //  leg42->AddEntry(resolutionPlotInvSquare,info ,"");
  leg42b->AddEntry(resolutionPlotInvSquare,"#phi_{eq} = 2.1 #times10^{15} cm^{-2}, proton" ,"ep");
  leg42b->AddEntry(resolutionPlotInvSquare,"600V, optimal angle" ,"");
  leg42b->AddEntry(fit32,"#sigma_{intr}^{2}+(#sigma_{MS}/momentum)^{2}" , "l");
  leg42b->Draw();
