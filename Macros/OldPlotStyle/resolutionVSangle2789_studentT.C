...
void resolutionVSangle2789_studentT(TString function = "RMS")
{
  ...
  MapTH1 res_map;
  int i_dphcut[dphcuts] = {8};
  TString ss_dphcut[dphcuts] = {"8"};
  ...
  ofstream myfile;
  myfile.open ("/home/zoiirene/Output/TextFiles/Ascan_"+detectorB+"_dphcutB"+ss_dphcut[0]+"_"+function+".txt");
  myfile << "A " << detectorA << "\n";
  myfile << labelA << "\n";
  myfile << "B " << detectorB<< "\n";
  myfile << labelB << "\n";
  ...
  for(int i=0; i<Angles; i++)
      ...
      if(it2  != res_map.end())
	{
	  ...
	  FitTH1(it2->second, &(RMS[i]), &(RMSError[i]), ss_Angle[i]+"_dphcutB"+ss_dphcut[0]+"_", detectorA, detectorB, detectorC, function );
  ...
  DrawTGraphWithErrorDouble(Angles, Angle, RMS, RMSError, Hist,"2789", Label[0], "angleScan_dphcutB"+ss_dphcut[0]+"_rms", "RMS 95% [#mum]",-7.,29.,0.,8., "angleScan", "Angle [degrees]"  );
  ...
  DrawTGraphWithErrorDouble(Angles, Angle, Resolution, ResolutionError, Hist,"2789", Label[0], "angleScan_dphcutB"+ss_dphcut[0]+"_res", "Resolution [#mum]",-7.,29.,0.,8., "angleScan", "Angle [degrees]"  );
  ...
  ofstream myfile3;
  myfile3.open ("/home/zoiirene/Output/TextFiles/Ascan_clsizeB_"+detectorB+"_dphcutB"+ss_dphcut[0]+"_"+"_"+function+".txt");
  myfile3 << "A " << detectorA << "\n";
  myfile3 << labelA << "\n";
  myfile3 << "B " << detectorB<< "\n";
  myfile3 << labelB << "\n";
