...
void resolution_2775_TreeEntries(TString function = "RMSself")
{
  ...
  TString labelB[Angles]={"Pstop_default_FDB thr 12 ADC"};
  TString labelC[Angles]={"Pspray_RD53Apads_FDB, thr 15 ADC"};
