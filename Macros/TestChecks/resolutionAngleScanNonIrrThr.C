...
void resolutionAngleScanNonIrrThr(TString name = "preliminary_ThrScanNonIrrABC", TString func = "RMS95", bool unfolding = false){
  ...
  for(int i = 0; i < dphcuts; i++){
    filenames[i] = "Ascan_resTree_148_dphcutB"+ss_dphcut[i]+"_RMS95_testThrABC.txt";
    filenames2[i] = "Ascan_clsizeB_148_dphcutB"+ss_dphcut[i]+"_RMS95_testThrABC.txt";
  }
