...
void resolutionAngleScan(TString thr="500",TString name = "preliminary", TString func = "RMS", bool unfolding = false)
{
  ...
  irr[1] = "#phi_{eq} = 2.1 #times10^{15} cm^{-2}, proton";
  ...
  TLegend* leg3 = new TLegend(0.3,0.7,0.55,0.85);
  leg3->SetLineColor(0);
  ...
  pad1->cd(); 
  //  TDR2(c3);
  outname = outputDir+"ResolutionSummary_angleScans25_freshVSprot_withclsize_line2_newlabel_big"+name;
